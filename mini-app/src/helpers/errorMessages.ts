...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  DRIVER_TRIP_OVERLAP:
    "У вас уже есть активная поездка на это время. Выберите другое время.",
  PASSENGER_BOOKING_OVERLAP:
    "У вас уже есть бронь на поездку в это время. Проверьте «Мои поездки».",
  ACCOUNT_HAS_ACTIVE_OBLIGATIONS:
    "Сначала завершите или отмените активные поездки и брони, затем повторите удаление профиля.",
